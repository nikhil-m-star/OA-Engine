...
export default function Navbar({ problemId, problemTitle, onReset, hasProblem = false }: NavbarProps) {
  ...
  return (
    <div className="w-full shrink-0 z-50 pointer-events-none md:mt-2">
      <header className="pointer-events-auto mx-auto flex h-[60px] items-center bg-[#080808]/92 backdrop-blur-md px-5 text-[#eff2f6f2] select-none border border-white/[0.08] shadow-2xl transition-all duration-300
